...
最后总结一下，在这段实习让我学到了挺多东西的。我之前从来没有在公司待过，更别说做工程产品什么的了，这次实习让我体会了一把工业界的感觉。刚开始写产品开发代码的时候是诚惶诚恐的，就我这垃圾代码也能当产品？做个demo还差不多。但后来也算是适应了这种惶恐的心理。另一方面，我一开始是独立负责产品线上一个大的算法模块的所有内容，后来有一段时间更是几乎独立开发了一个产品，因此对于算法工程师所必须的一些能力有了比较好的锻炼。第二个项目的产品最后还成功交付出去了，成为了公司的（第？）一笔营收，甚至听说现在那块业务还成为了公司的一项重要业务。但同样，这次实习也给我带来了一些反思：

1. 关于公司的选择问题。创业公司常常压力比较大，我能力又不足，经常需要加班到非常晚且周末也会继续实习，这让我身心俱疲，所以之后找工作的时候都倾向于选择一些相对轻松的公司。
2. 关于项目进度的管理。由于项目进度常常很赶，我能力又不足，疯狂加班也只能勉强交差，在测试/风格/文档注释/设计方面做得就相当糟糕，项目的工期究竟该如何估算与管理呢？
3. 关于如何manage leader的期望。我的leader常常会对我的项目设立一个（对我来说）比较赶的期限，而我往往表示太赶了也不起作用，只能答应下来，最后就得靠高强度的加班来赶上，有时候还会无法在期限内完成高质量的工作，反而让我的leader对我的评价可能会比较低。通过这样的经历，我意识到管理leader的期望是非常重要的。如果在定项目期限的时候自己认为做不到，就一定要说自己做不到，而且要坚持要求延长期限；实在要做就砍需求。

总之这次实习让我学到了很多东西，也带来了很多反思，对我后面做选择和决定起到了很大的作用。
